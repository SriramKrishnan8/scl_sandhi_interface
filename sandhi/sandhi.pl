...
#use FindBin;
#require "$FindBin::Bin/apavAxa_any.pl";
#require "$FindBin::Bin/any_sandhi.pl";

use Cwd;
$path = cwd();

require "$path/sandhi/apavAxa_any.pl";
require "$path/sandhi/any_sandhi.pl";
